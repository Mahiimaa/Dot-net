            ...
            <div className="flex-1 flex flex-col">
                ...
                <div className="p-6">
                        ...
                        <table className="min-w-full table-auto border border-gray-300">
                            ...
                            <tbody>
                                {loading ? (
                                    ...
                                    <tr>
                                        <td colSpan="6" className="text-center py-6">No announcements found.</td>
                                    </tr>
                                ) : (
                    ...
                    {showAddModal && (
                        <div className="fixed inset-0 bg-gray-800/40 flex items-center justify-center z-50">
                            <div className="bg-white rounded-md p-6 w-[90%] max-w-2xl shadow-lg">
                                <h2 className="text-center text-lg font-semibold mb-4">Add New Announcement</h2>
                                {error && (
                    ...
                    {showEditModal && (
                        <div className="fixed inset-0 bg-gray-800/40 flex items-center justify-center z-50">
                            <div className="bg-white rounded-md p-6 w-[90%] max-w-2xl shadow-lg">
                                <h2 className="text-center text-lg font-semibold mb-4">Edit Announcement</h2>
                                {error && (
                                    <div className="bg-red-100 text-red-700 p-3 rounded mb-4">{error}</div>
                                )}
                                <div className="grid grid-cols-2 gap-4">
