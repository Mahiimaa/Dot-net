...
//             {cartItems.map((item) => (
//               <div key={item.id} className="border p-4 flex gap-4 rounded-md relative">
...
//                     <span className="line-through text-gray-400">Rs {item.originalPrice}</span>
//                     <span className="text-blue-700 font-semibold">Rs {item.price}</span>
//                   </div>
...
//           {/* Order Summary */}
//           <div className="w-1/3 bg-[#f7f0e8] p-6 rounded-md shadow">
