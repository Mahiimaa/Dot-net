...
const Pagination = ({
    ...
    return (
        <div className={`flex flex-col items-center gap-4 ${className}`} role="navigation" aria-label={ariaLabel}>
            <div className="flex items-center gap-2">
                ...
                {pages.map((page) => (
                    <button
                        ...
                        disabled={loading}
                        className={`px-3 py-1 rounded ${currentPage === page ? 'bg-[#1b3a57] text-white' : 'bg-gray-200 text-black'} hover:bg-[#0d2a40] hover:text-white disabled:bg-gray-300 disabled:cursor-not-allowed`}
